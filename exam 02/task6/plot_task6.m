...
plot(a1.get('time'), a1.get('power'), 'Linewidth', 2, 'DisplayName', 'y_2');
grid;
grid minor;
ylabel 'Power [W]';
xlabel 'Time [s]';
...
plot(b1.get('time'), b1.get('power'), 'Linewidth', 2, 'DisplayName', 'y_2');
grid;
grid minor;
ylabel 'Power [W]';
xlabel 'Time [s]';
...
plot(c1.get('time'), c1.get('power'), 'Linewidth', 2, 'DisplayName', 'y_2');
grid;
grid minor;
ylabel 'Power [W]';
xlabel 'Time [s]';
...
plot(d1.get('time'), d1.get('power'), 'Linewidth', 2, 'DisplayName', 'y_2');
grid;
grid minor;
ylabel 'Power [W]';
xlabel 'Time [s]';
