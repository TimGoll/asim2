...
params_PC2.Em			= 30.0e9;				%	Martensite modulus of elasticity	[N/m^2]
params_PC2.epsilonT 	= 0.045;				%	"epsilon T"	transformation strain	[-]
params_PC2.T0 			= 343;	             	%	temperature T0 for computing sigmaA_T		[K]
...
params_PC2.alpha 		= 210;					%	convection coefficient				[W/(m^2*K)]
params_PC2.cv 			= 0.4e3;				%	Heat capacity						[J/(kg*K)]
params_PC2.rho 			= 6500;					%	density								[kg/m^3]
params_PC2.latentHpls 	= 12e3*params_PC2.rho;		% 	Latent heat of phase transformation 	[J/m^3]
