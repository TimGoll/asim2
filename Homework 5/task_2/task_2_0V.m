...
params_voltage = 0;
%params.C1 = 2000*1e5;               %	DE Neo Hookean model coefficient [Pa]
%params.kv = 2000*1e5;               % 	DE viscoelastic model stiffness	[Pa]
%params.bv = 2000*1e5;
%params.epsilon_r = 4;		   %	DE relative permittivity (3..5)
